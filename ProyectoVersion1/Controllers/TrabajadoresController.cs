...
namespace ProyectoVersion1.Controllers
{
    public class TrabajadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Contraseña,Telefono,Cargo")] Trabajador trabajador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Contraseña,Telefono,Cargo")] Trabajador trabajador)
        {
            if (id != trabajador.Id)
            {
                return NotFound();
